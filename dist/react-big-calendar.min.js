!(function(e, t) {
  ...
  function Z(e, t, n) {
    ...
    return (
      t === K && (e = G(e, ve(e) % 10, 'year')),
      t === B && (e = G(e, ve(e) % 100, 'year')),
      t === H &&
        (e = (function(e, t, n) {
          var r = (fe(e) + 7 - (n || 0)) % 7
    ...
    return r && _t(r, e)
      ? (void 0 !== e.getBoundingClientRect && (n = e.getBoundingClientRect()),
        (n = {
          ...
          left: n.left + Mt(e) - (r.clientLeft || 0),
          width: n.width,
          height: n.height,
        }))
      : n
  ...
  var Lt = function(e) {
      'function' == typeof window[At] && window[At](e)
    },
    Ft = Ct,
    zt = (function(e) {
      function t() {
  ...
  function Fn(e) {
    return Rn(wn(e)).left + Ln(e).scrollLeft
  }
  function zn(e) {
    var t = yn(e),
      n = t.overflow,
  ...
  function Bn(e, t) {
    ...
    var n = t,
      ...
      E = Rn(g),
      _ = Kn({ reference: E, element: y, strategy: 'absolute', placement: o }),
          ...
          if (_) {
            if (a) {
              var x = 'y' === w ? qt : Jt,
                ...
                W = z[j],
                H = Mn(0, O[T], F[T]),
                V = b ? O[T] / 2 - A - H - I - M : C - H - I - M,
                U = b ? -O[T] / 2 + A + H + W + M : R + H + W + M,
                K = t.elements.arrow && On(t.elements.arrow),
                ...
                $ = _[w] + V - Y - B,
                X = _[w] + U - Y,
                q = Mn(p ? Math.min(P, $) : P, k, p ? Math.max(N, X) : N)
              ;(_[w] = q), (S[w] = q - k)
            }
            if (s) {
              var G = 'x' === w ? qt : Jt,
  ...
  function br(e) {
    ...
    return Kt({}, v, {
      ...
      modifiers: ((a = Kt({}, h, {
        ...
        preventOverflow: Kt({}, h.preventOverflow, {
          options: f
            ? Kt(
                { padding: f },
        ...
        arrow: Kt({}, h.arrow, {
          enabled: !!d,
          options: Kt({}, null == (o = h.arrow) ? void 0 : o.options, {
            element: d,
          }),
        }),
        flip: Kt({ enabled: !!l }, h.flip),
      })),
      void 0 === a && (a = {}),
      Array.isArray(a)
        ? a
  ...
  var wr = r.forwardRef(function(e, n) {
    var a = e.flip,
      ...
      M = (function(e, n, r) {
        var o = void 0 === r ? {} : r,
          ...
          f = o.modifiers,
          d = void 0 === f ? or : f,
          p = Bt(o, ['enabled', 'placement', 'strategy', 'modifiers']),
          v = t.useRef(),
    ...
    var V = e.children(
      Kt({}, j, {
        show: !!e.show,
        props: Kt({}, x.popper, { style: S.popper, ref: b }),
        arrowProps: Kt({}, x.arrow, { style: S.arrow, ref: y }),
      })
    )
    if (d) {
      var U = e.onExit,
  ...
  var Ar = (function() {
    function e(e, t) {
      ...
      ;(this.isDetached = !1),
        ...
        (this._removeDragOverFromOutsideListener = Tr(
          'dragover',
    ...
    return (
      ...
      (t.isSelected = function(e) {
        ...
        return !(!t || !this.selecting) && Cr(t, Rr(e))
      }),
      (t.filter = function(e) {
    ...
    return (
      ...
      (o._selectable = function() {
        var e = this,
          ...
          r = (this._selector = new Ar(this.props.container, {
  ...
  function no(e) {
    return (
      !(!We(e) || ((t = e), $r && $r in t)) && (Be(e) ? to : Gr).test(qr(e))
    )
    var t
  }
  function ro(e, t) {
  ...
  ;((_a && '[object DataView]' != Pa(new _a(new ArrayBuffer(1)))) ||
    ...
    (Da && '[object Set]' != Pa(new Da())) ||
    (Ma && '[object WeakMap]' != Pa(new Ma()))) &&
    (Pa = function(e) {
      var t = Ie(e),
  ...
  function $a(e, t) {
    ...
    return (
      ...
      (Ya.test(e) || !Ba.test(e) || (null != t && e in Object(t)))
    )
  }
  ...
  function Si(e, t, n) {
    var r = +Z(n.start(e), 'day') - +Z(n.start(t), 'day'),
      ...
      a = De(n.start(t), we(n.end(t), 'day'), 'day')
    return (
      r ||
  ...
  ;(Ai.propTypes = {}), (Ai.defaultProps = i({}, zr))
  var Ci = function(e) {
    var t = e.children
    return r.createElement(
      'div',
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                i({ isAllDay: D }, A),
                T.map(function(e, t) {
                  return r.createElement(Hr, i({ key: t, segments: e }, A))
                }),
                !!k.length &&
                  r.createElement(
                    Ai,
        ...
        return (
          ...
          (t.handleShowMore = function(e, r, o, a, i) {
            ...
            if ((t.clearSelection(), c)) {
              var p = kt(o, n.findDOMNode(R(t)))
              t.setState({
                overlay: { date: r, events: e, position: p, target: i },
              })
            } else d && k(l, [r, f(r) || j.DAY])
            k(u, [e, r, a])
          }),
            ...
            var e = n.findDOMNode(R(t)),
              ...
              o = function(e) {
                var n = t.props.onSelecting,
                  ...
                  s = o.endDate
                ;(n &&
                  ((Q(r.startDate, i, 'minutes') &&
                    Q(r.endDate, s, 'minutes')) ||
                    !1 ===
        ...
        (o.render = function() {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                'div',
                { className: S('rbc-events-container', o && 'rtl') },
                this.renderEvents({
        ...
        return e.map(function(e, n) {
          ...
          return r.createElement(
            'div',
            {
              key: n,
              style: p,
              className: S('rbc-header', d, Q(e, u, 'day') && 'rbc-today'),
            },
            i
              ? r.createElement(
                  'a',
      ...
      (n.render = function() {
        ...
        return r.createElement(
          'div',
          {
            style: E,
            ref: p,
            className: S('rbc-time-header', h && 'rbc-overflowing'),
          },
          r.createElement(
            'div',
            {
    ...
    return (
      ...
      (t.prototype.render = function() {
        var e = this.props,
          ...
          o = s(e, ['date']),
          a = t.range(n)
        return r.createElement(Ts, i({}, o, { range: a, eventOffset: 10 }))
      }),
      t
    )
  })(r.Component)
  ...
  var Ps = (function(e) {
    ...
    return (
      ...
      (t.prototype.render = function() {
        ...
        return r.createElement(Ts, i({}, o, { range: a, eventOffset: 15 }))
      }),
      t
    )
  })(r.Component)
  ...
  ;(Ps.propTypes = {}),
    (Ps.defaultProps = Ts.defaultProps),
      ...
      return (
        ...
        (t.prototype.render = function() {
          var e = this.props,
            ...
            n = s(e, ['date']),
            o = Ns(t, this.props)
          return r.createElement(Ts, i({}, n, { range: o, eventOffset: 15 }))
        }),
        t
      )
    })(r.Component)
        ...
        if (h.current) {
          ...
          if (t) {
            var n,
              ...
              a = [],
              i = a
            ;(a = [Ds(t.children[0]), Ds(t.children[1])]),
              (i[0] === a[0] && i[1] === a[1]) ||
  ...
  function Us(e, t, n) {
    var r = e[t]
    ;(Vs.call(e, t) && Se(r, n) && (void 0 !== n || t in e)) || Hs(e, t, n)
  }
  function Ks(e, t, n, r) {
    var o = !n
    n || (n = {})
    for (var a = -1, i = t.length; ++a < i; ) {
      ...
      void 0 === c && (c = e[s]), o ? Hs(n, s, c) : Us(n, s, c)
    }
    return n
  }
  ...
  var rc = /\w*$/
  var oc = ke ? ke.prototype : void 0,
    ac = oc ? oc.valueOf : void 0
    ...
    if (kc(e))
      return (
        e.forEach(function(r, o) {
          i.set(o, Vc(r, t, n, o, e, a))
        }),
        i
      )
    var v = l ? (c ? ec : ba) : c ? keysIn : ya,
      h = u ? void 0 : v(e)
    return (
      Ws(h || e, function(r, o) {
        h && (r = e[(o = r)]), Us(i, o, Vc(r, t, n, o, e, a))
      }),
      i
    )
  }
  function Uc(e, t) {
    return (
      null ==
        (e = (function(e, t) {
          return t.length < 2 ? e : fi(e, Me(t, 0, -1))
        })(e, (t = ci(t, e)))) ||
      delete e[
  ...
  ;(Hc[Fc] = Hc['[object Array]'] = Hc['[object ArrayBuffer]'] = Hc[
    '[object DataView]'
  ...
  var Jc = (function(e) {
    ...
    tl = us(function(e, t) {
      ...
      for (o && Je(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var a = t[n], i = $s(a), s = -1, c = i.length; ++s < c; ) {
          var l = i[s],
            u = e[l]
          ;(void 0 === u || (Se(u, Qc[l]) && !el.call(e, l))) && (e[l] = a[l])
        }
      return e
    })
  var nl = function(e) {
      ...
      return (
          ...
          return Array.isArray(o)
            ? (function(e, t, n) {
                ...
                if (((t = bi(t)), null == n)) {
                  ...
                  n = o ? (r ? new a() : []) : We(e) && Be(a) ? xc(Js(e)) : {}
                }
                return (
                  (o ? Ws : Ji)(e, function(e, r, o) {
                    return t(n, e, r, o)
                  }),
                  n
                )
        ...
        (t.handleNavigate = function(e, n) {
          var r = t.props,
            ...
            d = c()
          l(
            (a = zs(f, i({}, u, { action: e, date: n || a || d, today: d }))),
            o,
            e
          ),
    ...
    return (
      ...
      (n.render = function() {
        ...
        var b = this.getView(),
          ...
          M = w.viewNames,
          x = _.toolbar || Is,
          j = b.title(d, { localizer: D, length: v })
        return r.createElement(
          'div',
          i({}, f, {
            className: S(u, 'rbc-calendar', y.rtl && 'rbc-rtl'),
            style: l,
          }),
          n &&
            r.createElement(x, {
  ...
  var pl = function(e, t, n) {
    ...
    hl = { eventWrapper: a, timeSlotWrapper: a, dateCellWrapper: a }
  ;(e.Calendar = al),
    (e.DateLocalizer = N),
    (e.Navigate = x),
    (e.Views = j),
